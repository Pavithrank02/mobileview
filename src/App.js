...
function App() {
  ...
  return (
    <Grid container
      sx={{
        flexDirection: { xs: 'column', md: 'row' }, // Column layout for xs, row layout for md and up
        width: '100%',
    ...
    >
      ...
      <Grid item xs={12} md={3}
        sx={{
          ...
          position: { md: 'fixed' },
          height: { xs: 'auto', md: '100vh' }, // Full height only on md screens and up
          width: { md: '25vw' }, // Fixed width for md screens and up
      ...
      <Grid item xs={12} md={9}
        sx={{
          ...
          width: { xs: '100%', md: '75vw' }, // Ensure it uses the correct width based on the screen size
          minHeight: '100vh', // Match the minimum height of the SideNav
        }}
      >
        <Routes>
